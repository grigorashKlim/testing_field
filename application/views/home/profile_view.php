<div class="row ">
    ...
    <div class="col-7">
        <form action="" method="post" class="rf">
            ...
            <br>
            Пароль: <br> <input type="text" name="password" id="password" class="rfield"
                                value='<?php echo $data['password']; ?>'>
            <br>
            Подтвердите пароль: <br> <input type="text" name="repassword" id="repassword" class="rfield"
                                            value='<?php print_r($data['password']); ?>'>
            <br>
